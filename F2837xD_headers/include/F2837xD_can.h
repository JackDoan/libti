...
struct CAN_REGS {
    ...
    unsigned long                                    rsvd4[18];                    // Reserved
    ...
    unsigned long                                    rsvd10[4];                    // Reserved
    ...
    unsigned long                                    rsvd11[4];                    // Reserved
    ...
    unsigned long                                    rsvd12[4];                    // Reserved
