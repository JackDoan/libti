...
const struct PIE_VECT_TABLE PieVectTableInit = {
    ...
    PIE_RESERVED_ISR,             // Reserved
    PIE_RESERVED_ISR,             // Reserved
    PIE_RESERVED_ISR,//TIMER1_ISR,                   // CPU Timer 1 Interrupt
    PIE_RESERVED_ISR,//TIMER2_ISR,                   // CPU Timer 2 Interrupt
    PIE_RESERVED_ISR,//DATALOG_ISR,                  // Datalogging Interrupt
    PIE_RESERVED_ISR,//RTOS_ISR,                     // RTOS Interrupt
    PIE_RESERVED_ISR,//EMU_ISR,                      // Emulation Interrupt
    PIE_RESERVED_ISR,//NMI_ISR,                      // Non-Maskable Interrupt
    PIE_RESERVED_ISR,//ILLEGAL_ISR,                  // Illegal Operation Trap
    PIE_RESERVED_ISR,//USER1_ISR,                    // User Defined Trap 1
    PIE_RESERVED_ISR,//USER2_ISR,                    // User Defined Trap 2
    PIE_RESERVED_ISR,//USER3_ISR,                    // User Defined Trap 3
    PIE_RESERVED_ISR,//USER4_ISR,                    // User Defined Trap 4
    PIE_RESERVED_ISR,//USER5_ISR,                    // User Defined Trap 5
    PIE_RESERVED_ISR,//USER6_ISR,                    // User Defined Trap 6
    PIE_RESERVED_ISR,//USER7_ISR,                    // User Defined Trap 7
    PIE_RESERVED_ISR,//USER8_ISR,                    // User Defined Trap 8
    PIE_RESERVED_ISR,//USER9_ISR,                    // User Defined Trap 9
    PIE_RESERVED_ISR,//USER10_ISR,                   // User Defined Trap 10
    PIE_RESERVED_ISR,//USER11_ISR,                   // User Defined Trap 11
    PIE_RESERVED_ISR,//USER12_ISR,                   // User Defined Trap 12
    PIE_RESERVED_ISR,//ADCA1_ISR,                    // 1.1 - ADCA Interrupt 1
    PIE_RESERVED_ISR,//ADCB1_ISR,                    // 1.2 - ADCB Interrupt 1
    PIE_RESERVED_ISR,//ADCC1_ISR,                    // 1.3 - ADCC Interrupt 1
    PIE_RESERVED_ISR,//XINT1_ISR,                    // 1.4 - XINT1 Interrupt
    PIE_RESERVED_ISR,//XINT2_ISR,                    // 1.5 - XINT2 Interrupt
    PIE_RESERVED_ISR,//ADCD1_ISR,                    // 1.6 - ADCD Interrupt 1
    PIE_RESERVED_ISR,//TIMER0_ISR,                   // 1.7 - Timer 0 Interrupt
    PIE_RESERVED_ISR,//WAKE_ISR,                     // 1.8 - Standby and Halt Wakeup Interrupt
    PIE_RESERVED_ISR,//EPWM1_TZ_ISR,                 // 2.1 - ePWM1 Trip Zone Interrupt
    PIE_RESERVED_ISR,//EPWM2_TZ_ISR,                 // 2.2 - ePWM2 Trip Zone Interrupt
    PIE_RESERVED_ISR,//EPWM3_TZ_ISR,                 // 2.3 - ePWM3 Trip Zone Interrupt
    PIE_RESERVED_ISR,//EPWM4_TZ_ISR,                 // 2.4 - ePWM4 Trip Zone Interrupt
    PIE_RESERVED_ISR,//EPWM5_TZ_ISR,                 // 2.5 - ePWM5 Trip Zone Interrupt
    PIE_RESERVED_ISR,//EPWM6_TZ_ISR,                 // 2.6 - ePWM6 Trip Zone Interrupt
    PIE_RESERVED_ISR,//EPWM7_TZ_ISR,                 // 2.7 - ePWM7 Trip Zone Interrupt
    PIE_RESERVED_ISR,//EPWM8_TZ_ISR,                 // 2.8 - ePWM8 Trip Zone Interrupt
    PIE_RESERVED_ISR,//EPWM1_ISR,                    // 3.1 - ePWM1 Interrupt
    PIE_RESERVED_ISR,//EPWM2_ISR,                    // 3.2 - ePWM2 Interrupt
    PIE_RESERVED_ISR,//EPWM3_ISR,                    // 3.3 - ePWM3 Interrupt
    PIE_RESERVED_ISR,//EPWM4_ISR,                    // 3.4 - ePWM4 Interrupt
    PIE_RESERVED_ISR,//EPWM5_ISR,                    // 3.5 - ePWM5 Interrupt
    PIE_RESERVED_ISR,//EPWM6_ISR,                    // 3.6 - ePWM6 Interrupt
    PIE_RESERVED_ISR,//EPWM7_ISR,                    // 3.7 - ePWM7 Interrupt
    PIE_RESERVED_ISR,//EPWM8_ISR,                    // 3.8 - ePWM8 Interrupt
    PIE_RESERVED_ISR,//ECAP1_ISR,                    // 4.1 - eCAP1 Interrupt
    PIE_RESERVED_ISR,//ECAP2_ISR,                    // 4.2 - eCAP2 Interrupt
    PIE_RESERVED_ISR,//ECAP3_ISR,                    // 4.3 - eCAP3 Interrupt
    PIE_RESERVED_ISR,//ECAP4_ISR,                    // 4.4 - eCAP4 Interrupt
    PIE_RESERVED_ISR,//ECAP5_ISR,                    // 4.5 - eCAP5 Interrupt
    PIE_RESERVED_ISR,//ECAP6_ISR,                    // 4.6 - eCAP6 Interrupt
